    ...
    items: [
      {
        ...
        link: RouteNames.MY_TRAININGS + '/some_generated_id_for_impact_speed',
      },
      {
        id: generateId(),
        name: 'Сила удару',
        icon: <SportsGymnasticsIcon />,
        link: RouteNames.MY_TRAININGS + '/some_generated_id_for_impact_power',
      },
      {
        id: generateId(),
        name: 'Додати характеристику',
        icon: <AddCircleIcon />,
        link: RouteNames.MY_TRAININGS + '/add',
      },
    ],
  },
  {
